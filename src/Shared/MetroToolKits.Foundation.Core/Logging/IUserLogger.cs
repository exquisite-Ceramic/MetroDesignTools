...
public interface IUserLogger
{
    ...
    // ── 双向定位 ──────────────────────────────────────────────────────────────
    void SourceElementLocated(string elementType, string sourceHandle);
    void SourceElementLocationFailed(string reason);
    void RelatedSectionsFound(string sourceHandle, int count);
    void NoRelatedSectionsFound(string sourceHandle);
}
