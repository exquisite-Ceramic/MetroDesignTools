...
public partial class WallTemplatePanel : UserControl
{
    private readonly ObservableCollection<WallAssemblyTemplateDto> _templates = new();
    private IWallAssemblyTemplateCatalog? _templateCatalog;
    private IWallTemplateCatalogMapper? _templateCatalogMapper;
        ...
        IWallTemplateCatalogMapper templateCatalogMapper)
    {
        if (_initialized)
        {
            throw new InvalidOperationException("WallTemplatePanel has already been initialized.");
        }
    ...
    private void EnsureInitialized()
    {
        if (!_initialized)
        {
            throw new InvalidOperationException("WallTemplatePanel has not been initialized.");
        }
    }
